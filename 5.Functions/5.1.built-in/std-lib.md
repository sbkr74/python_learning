**Python 3** comes with a rich standard library of `built-in modules` that provide a wide range of functionalities. Here is a categorized list of many of the `built-in modules` available in Python 3:
